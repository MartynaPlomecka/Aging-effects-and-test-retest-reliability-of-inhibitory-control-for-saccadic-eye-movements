...
theme(plot.title = element_text(color="grey16", size=21)) +
...
eneuro2 = grid.arrange(p3, p4, nrow = 1,
                       top=textGrob("Proportion of correct trials",gp=gpar(fontsize=20,fontface='bold')))
...
```{r}
a = grid.arrange(eneuro,eneuro2, nrow=2)
```